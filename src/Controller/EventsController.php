...
class EventsController extends AbstractController
{
    ...
    #[Route('/filter/{type}', name: 'filter_events', methods: ['GET'])]
    public function filterEventsByType($type, EventsRepository $eventRepository): Response
    {
        $events = $eventRepository->findBy(['type' => $type]);

        $template = match ($type) {
            'art' => 'events/arts.html.twig',
            'music' => 'events/musics.html.twig',
            'education' => 'events/educations.html.twig',
            'sport' => 'events/sports.html.twig',
            default => 'events/index.html.twig',
        };
